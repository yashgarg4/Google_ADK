...
post_reviewer = LlmAgent(
    ...
    Your task is to evaluate the quality of a given LinkedIn post.
    ...
    3. If the length check passes, evaluate the post against these general criteria:
       - REQUIRED ELEMENTS:
         1. A clear and relevant topic
         2. A clear call-to-action
         3. A professional tone
         4. Engaging and conversational style
